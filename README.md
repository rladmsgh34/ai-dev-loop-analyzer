...
# 프로파일 적용 (프로젝트별 키워드/규칙 사용)
python3 src/analyze.py --profile profiles/examples/nextjs-prisma.json
# 또는 환경변수로
AI_DEV_LOOP_PROFILE=my-project.json python3 src/analyze.py
...
기본값: PR 제목이 `fix`로 시작하면 fix PR로 분류됩니다.  
프로파일의 `fix_pr_regex` 필드로 변경 가능합니다.
